...
function optionsframework_add_admin()
{
    ...
    $of_page = add_menu_page($themename, 'Theme Admin Panel', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page', get_bloginfo('template_url') . '/admin/images/wrench.png'); // Default
...
function optionsframework_options_page()
{
    ...
    <div class="wrap" id="of_container">
        <div id="of-popup-save" class="of-save-popup">
            <div class="of-save-save">Settings has been updated!</div>
        </div>
        <div id="of-popup-reset" class="of-save-popup">
            <div class="of-save-reset">Settings has been reseted!</div>
        </div>
        <form action="" enctype="multipart/form-data" id="ofform">
            ...
            <div class="save_bar_top">
                <img style="display:none"
                     src="<?php echo bloginfo('stylesheet_directory'); ?>/admin/images/loading-bottom.gif"
                     class="ajax-loading-img ajax-loading-img-bottom" alt="Working..."/>
                <input type="submit" value="Save Settings" class="button-primary"/>
        </form>
        <form action="<?php echo esc_attr($_SERVER['REQUEST_URI']) ?>" method="post" style="display:inline;"
              id="ofform-reset">
    <span class="submit-footer-reset">
    <input name="reset" type="submit" value="Reset Settings" class="button submit-button reset-button"
           onclick="return confirm('Is settings been reseted?');"/>
...
function optionsframework_uploader_function($id, $std, $mod)
{
    ...
    $uploader .= '<span class="button image_reset_button ' . $hide . '" id="reset_' . $id . '" title="' . $id . '">Delete</span>';
    $uploader .= '</div>' . "\n";
