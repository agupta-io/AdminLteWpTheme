...
<head>
    ...
    <!-- jQuery 2.2.3 -->
    <script src="<?php bloginfo('template_url'); ?>/vendor/AdminLTE/bower_components/jquery/dist/jquery.min.js"></script>
    <script>
    ...
    <header class="main-header">
        ...
        <?php else: ?>
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu"> <!-- <?php wp_nav_menu_no_ul() ?> -->
